...
This report therefore recommends (and the companion implementation supports) additional metadata elements for NuSEDS uploads, including:
...
These elements are summarized in Methods (Table \@ref(tab:recommended-metadata-table)). In the companion toolkit implementation, these elements are reflected in the returned qualifier codes so that Type assignment is transparent to data users [@smnToolkitShiny].
