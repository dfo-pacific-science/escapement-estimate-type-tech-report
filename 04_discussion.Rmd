...
The current Shiny implementation explicitly surfaces remaining policy and specification gaps that can still affect cross-program consistency if left implicit [@smnToolkitShiny]. The most material items are:
