...
These elements are summarized in the recommended metadata table in Methods. In the companion toolkit implementation, these elements are reflected in the returned qualifier codes so that Type assignment is transparent to data users [@smnToolkitShiny].
