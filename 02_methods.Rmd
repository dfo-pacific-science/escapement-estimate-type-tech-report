...
The Escapement Estimate Type Toolkit (R Shiny application) applies this decision logic and returns both (i) a final estimate Type (1--6) and (ii) qualifier codes explaining any conservative downgrades. The toolkit is a practical companion tool; it is **not** the primary output of this report.
