...
A method family is a broad grouping of enumeration and estimation methods that share the same underlying approach or sampling design. Individual methods within a family may differ in implementation details while maintaining the same fundamental methodology. Families are ordered by best attainable Type to foreground the upper bound implied by the guidance; short codes are retained for toolkit use.
