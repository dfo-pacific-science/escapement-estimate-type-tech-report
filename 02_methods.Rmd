...
**Note:** The field names below are illustrative. The key point is that these elements are (i) recorded by the guidance as explicit qualifier codes and (ii) recommended for storage in NuSEDS so that Type assignment is transparent to data users.
