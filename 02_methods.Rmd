...
A best attainable Type 2 for redd surveys is only intended where a validated spawners-per-redd conversion supports a qualified absolute-abundance estimate; otherwise the pathway remains relative and is conservatively capped lower.
