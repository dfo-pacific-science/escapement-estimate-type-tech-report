...
est_crosswalk[["Notes"]][est_crosswalk[[1]] == "Cumulative New"] <-
  "Legacy dictionary label with no method definition in the source description; treat conservatively as method unknown unless program-specific documentation exists."
